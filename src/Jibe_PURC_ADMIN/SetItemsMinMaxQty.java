...
public class SetItemsMinMaxQty extends RW{
		...
		public void MinMaxQuantityURL (WebDriver driver1) throws Exception {  //(priority=9)
			...
			WebDriver driver = driver1;
		     ...
		     //  URL Path Concat
		     String input_purc_URL =url.concat(input_purc_m.getData(2, 82, 4));
		...
		public void SearchCatalogueItems(WebDriver driver1) throws Exception {  //(priority=10)
